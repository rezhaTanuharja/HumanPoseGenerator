...
from humanposegenerator.models.modulators import NewFiLM
from humanposegenerator.pipelines.encoders import create_encoder

CONFIG = CONFIG["pose_generator"]
...
checkpoint = torch.load(
    "humanposegenerator/checkpoints/train_512.pth",
    weights_only=True,
)
...
for j in range(num_times + 1):
    ...
    if j % 10 == 0:
        ...
        plt.savefig(f"./output_files/sampling/prior_3/martial_arts_{(j + 0):04}.jpg")
        plt.close()
